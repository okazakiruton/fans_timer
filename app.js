...
const REACTIONS = [
  ...
  { id:'angry', label:'怒り', keywords:['怒った','おこった','怒ったよ','なんでだよ','なんでだ','許さん','許さない','ふざけんな','ふざけるな','マジ怒','マジで怒った','ぷんぷん','プンプン','むかつく','ムカつく','ばうむ','はらたつ','イライラ','いらいら','キレた','きれた','切れた','激怒','げきど','おこだよ','バウムクーヘン','おこだ','おこりんぼ','グヌヌ','ぐぬぬ','バウム','おこりしんとう','頭に来た','あたまにきた','ふざけないで','ふざけないでよ','あんまりだ','ひどすぎる','許せない','ゆるせない','バームクーヘン','がまんのげんかい','angry','Angry','mad','Mad','カンカン','かんかん','ぶちギレ','ぶちぎれ'], minStage:'egg',
    play: async ()=>{
