...
const REACTIONS = [
  ...
  { id:'angry', label:'怒り', keywords:['怒った','おこった','怒ったよ','なんでだよ','なんでだ','許さん','許さない','ふざけんな','ふざけるな','マジ怒','マジで怒った','ぷんぷん','プンプン','むかつく','ムカつく','腹立つ','はらたつ','イライラ','いらいら','キレた','きれた','切れた','激怒','げきど','おこだよ','おこだぞ','おこだ','おこりんぼ','グヌヌ','ぐぬぬ'], minStage:'egg',
  ...
  { id:'toilet', label:'トイレ', keywords:['トイレ','といれ','トイレット','おしっこ','オシッコ','うんち','ウンチ','wc','WC','Wc','お手洗い','おてあらい','化粧室','けしょうしつ','便所','べんじょ','レストルーム','restroom','小用','しょうよう','大用','トイレ休憩','といれきゅうけい','おトイレ','おといれ','尿意','にょうい','催した','もよおした','トイレタイム'], minStage:'baby', pausesIdle:false,
  ...
  { id:'sleep', label:'寝る', keywords:['ねむい','眠い','ネムイ','寝る','寝ます','ねる','おやすみ','おやすみなさい','オヤスミ','ねむ','ネム','眠たい','ねむたい','睡魔','すいま','うとうと','ウトウト','こっくり','コックリ','寝落ち','ねおち','あくび','アクビ','欠伸','眠気','ねむけ','すやすや','スヤスヤ','就寝','しゅうしん','zzz','ZZZ'], minStage:'baby',
    play: async ()=>{ await sleepAnim(); } },
  { id:'stretch', label:'ストレッチ', keywords:['ストレッチ','すとれっち','ストレッチタイム','伸び','のび','背伸び','せのび','体操','たいそう','肩こり','かたこり','肩凝り','首痛い','くびいたい','腰伸ばす','こしのばす','腰痛い','こしいたい','リフレッシュ','りふれっしゅ','筋伸ばし','ストレッチしよ','ストレッチしよう','体をほぐす','からだをほぐす','ラジオ体操','らじおたいそう','ヨガ','よが','深呼吸','しんこきゅう'], minStage:'adult',
    play: async ()=>{ await stretchAnim(); } },
  { id:'water', label:'給水', keywords:['水分補給','すいぶんほきゅう','水飲も','水飲もう','みずのも','のど渇いた','のどかわいた','喉渇いた','ドリンク','どりんく','お茶','おちゃ','コーヒー','こーひー','カフェイン','かふぇいん','水分','すいぶん','給水タイム','きゅうすいたいむ','ジュース','じゅーす','麦茶','むぎちゃ','水筒','すいとう','ペットボトル','ぺっとぼとる','一口','ひとくち'], minStage:'adult', pausesIdle:false,
